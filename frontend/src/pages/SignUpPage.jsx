...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-[#E3CDD3]'>Create your account</h2>
			</motion.div>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									placeholder='luana_georgescu@example.com'
								/>
							</div>
						</div>
